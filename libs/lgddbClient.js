...
const REGION = config.LG_DYNAMO_DB.REGION; //e.g. "us-east-1"
const ACCESS_KEY_ID = config.LG_DYNAMO_DB.ACCESS_KEY_ID;
const SECRET_ACCESS_KEY = config.LG_DYNAMO_DB.SECRET_ACCESS_KEY;
